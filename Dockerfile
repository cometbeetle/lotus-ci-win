...
RUN Invoke-WebRequest -Uri 'https://download.oracle.com/otn_software/nt/instantclient/2380000/instantclient-basic-windows.x64-23.8.0.25.04.zip' -OutFile instantclient-basic-windows.x64-23.8.0.25.04.zip
